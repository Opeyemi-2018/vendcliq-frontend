...
const Cart = () => {
  ...
  return (
    <div className="">
      <h1 className="text-[#2F2F2F] text-[20px] md:text-[25px] font-clash font-semibold mb-8">
        ...
        {cartItems.map((item) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-20 h-20 border border-[#E3E3E3] p-3 bg-[#FAFAFA] rounded-xl overflow-hidden flex-shrink-0">
                <Image
                  height={100}
                  width={100}
                  src={
