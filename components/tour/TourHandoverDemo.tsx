...
const STEPS = [
  {
    n: 1,
    title: "Pick the item",
    body: "Give one item now and the rest later.",
    chip: "Pending",
    chipBg: "#FFF3DB",
    chipFg: "#85540A",
  },
  {
    ...
    body: "The customer types the code sent to their phone. A driver finishes it on their own app.",
  ...
  },
  {
    ...
    body: "Type what they read out and the item shows as Completed.",
    chip: "Completed",
    chipBg: "#E7F4EB",
    chipFg: "#003909",
  },
